...
Du kannst den ATLAS Card Editor wie ioBroker, FHEM oder andere lokale Web-UIs
direkt in Home Assistant anzeigen:
...
To show the ATLAS Card Editor inside Home Assistant, go to
**Settings -> Dashboards**, add a **Webpage** dashboard, use
