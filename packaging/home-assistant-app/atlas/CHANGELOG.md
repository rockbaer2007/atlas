...
- Include the pinned Oh My Posh binary and Bash in the Home Assistant App image.
- Bump the ATLAS framework to `0.2.0-alpha.79`.
...
- Bump the Home Assistant Card Editor package to `0.2.0-alpha.93`.
...
- Make the Expert Card Editor palette panel taller and slightly wider so card
  entries have more room.
- Bump the Home Assistant Card Editor package to `0.2.0-alpha.85`.
...
- Write imported template and style blocks as YAML block scalars.
- Bump the Home Assistant Card Editor package to `0.2.0-alpha.68`.
