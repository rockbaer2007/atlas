  ...
  _render() {
    this.shadowRoot.innerHTML = `
      ...
      <div class="panel">
        ...
        <div class="links">
          <a class="primary" href="https://my.home-assistant.io/redirect/hacs_repository/?owner=rockbaer2007&repository=tabbed-card-v2&category=plugin" target="_blank" rel="noreferrer">
            HACS installieren
          </a>
        ...
        <p>
          Bis das eigene HACS-Panel veroeffentlicht ist, kannst du die YAML-Konfiguration ueber
