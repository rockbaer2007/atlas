...
const translations = {
  en: {
    ...
    "release.standalone-docker.reason": "Dockerfile and Compose wiring exist; the image still needs a verified Docker build on a host with Docker installed.",
    "release.home-assistant-app.label": "Home Assistant App / Add-on",
    "release.home-assistant-app.reason": "Derive the Home Assistant App/Add-on package from the same container and runtime after Docker is stable.",
  ...
  de: {
    ...
    "release.standalone-docker.label": "Standalone-Docker-Container",
    "release.standalone-docker.reason": "Dockerfile und Compose-Verdrahtung sind vorhanden; das Image braucht noch einen verifizierten Docker-Build auf einem Host mit Docker.",
    "release.home-assistant-app.label": "Home Assistant App / Add-on",
    "release.home-assistant-app.reason": "Leite die Home-Assistant-App/Add-on-Verpackung aus demselben Container und Runtime-Pfad ab, sobald Docker stabil ist.",
    "release.linux-installer.label": "Linux-VM-/LXC-Installer",
