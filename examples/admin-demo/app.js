...
const translations = {
  en: {
    ...
    "link.openEditor": "Open Card Editor on port 4174",
    ...
    "policy.token": "Raw access tokens are not passed to plugins.",
  ...
  de: {
    ...
    "link.openEditor": "Card Editor auf Port 4174 oeffnen",
    ...
    "policy.token": "Rohe Access Tokens werden nicht an Plugins weitergegeben.",
