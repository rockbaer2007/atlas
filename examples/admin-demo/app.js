...
const translations = {
  en: {
    ...
    "release.standalone-docker.reason": "Build the first repeatable package as one container for Administration and the Card Editor.",
  ...
  de: {
    ...
    "release.standalone-docker.label": "Standalone-Docker-Container",
    "release.standalone-docker.reason": "Baue das erste wiederholbare Paket als einen Container für Administration und Card Editor.",
    "release.home-assistant-app.label": "Home Assistant App / Add-on",
