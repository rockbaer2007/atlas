...
- The ATLAS Automation Exporter / Editor should not provide a write-back function for Home Assistant system files. Opening or reading local automation files should still create a timestamped safety backup first.
