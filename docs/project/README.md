...
This section contains the long-term project documentation for ATLAS.

## Structure

-   **architecture/** -- Architecture reference documents and design
    overviews.
...
-   **STABILIZATION_REVIEW.md** -- G2.5 close-out review and next-phase
    guidance.
