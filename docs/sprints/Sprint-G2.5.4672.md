# Sprint G2.5.4672 - README Pending Attention Followup 2

## Summary

- Documented readme pending attention followup 2 for the split HACS readiness attention-groups workstream.
