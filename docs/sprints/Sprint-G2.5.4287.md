# Sprint G2.5.4287 - Formatter API Stability Followup 2

## Summary

- Documented formatter api stability followup 2 for the combined HACS package readiness review workstream.
